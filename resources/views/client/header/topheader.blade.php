        ...
        <div class="container">
            ...
            <div class="language ">
                <div class="dropdown">
                      ...
                      <img alt="email" src="{{url('public/assets/images/fr.jpg')}}" />French
                      
                      </a>
                      <ul class="dropdown-menu" role="menu">
                        <li><a href="#"><img alt="email" src="{{url('public/assets/images/en.jpg')}}" />English</a></li>
                        <li><a href="#"><img alt="email" src="{{url('public/assets/images/fr.jpg')}}" />French</a></li>
                    </ul>
                </div>
            </div>
